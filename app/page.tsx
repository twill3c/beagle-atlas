...
export default function Home() {
  ...
  return (
    <main>
      ...
      <p>
        E-03 は<strong>読み本文の側(S-B)の誤り</strong>で、しかも
        <strong>本文をどう読むかを外部の権威なしに決められた</strong>一件である。第 6 章は日付を
        追って進む章で、9・10・11・12 と 13・14・15・16・17・18・19・20 と一日ずつ欠けなく続く。
        章頭を 8 日と読めば 8 日から 20 日までの連続になるが、18 日と読むと順序が最初で壊れ、
        同じ 18 日が章の最初と最後に二度現れ、あいだの十日が行き場を失う。
        S-A は 8th と読む。<strong>数の並びそのものが裁定した</strong>ので、
        どちらの翻刻を信用するかを決め打ちせずに済んだ。
        それでも本文は書き換えていない —— 読み手が見るのは S-B のままの
